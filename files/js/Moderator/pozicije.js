$(document).ready(function(){
    ...
    function dohvatiPodatke()
    {
        var dataTable = $('#tablica').DataTable({
            ...
            "order" : [],
            "ajax" : {
                url:"http://localhost/moderator/pozicije",
                type:"POST"
            }
        });
    }
    ...
    $(document).on('click', '#insert', function(){
        ...
        {
            $.ajax({
                url:"http://localhost/moderator/pozicije/dodaj",
                method:"POST",
                data:{ naziv:naziv},
    ...
    $(document).on('click', '.delete', function(){
        ...
        {
            $.ajax({
                url:"http://localhost/moderator/pozicije/obrisi",
                method:"POST",
                data:{id:id},
                success:function(data){
                    $('#poruka').html('<div class="alert alert-success">'+data+'</div>');
    ...
    {
        $.ajax({
            url:"http://localhost/moderator/pozicije/azuriraj",
            method:"POST",
